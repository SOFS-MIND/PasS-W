...
<table width="100%" border="0">
  ...
  <tr>
   ...
   <table width="90%" border="1">
    ...
    <td width="14%" height="37" align="center"><strong>Security Id No</strong></td>
...
<?php
$sel = "select * from security order by sec_idno asc";
$from = mysql_query($sel);
while($res=mysql_fetch_object($from))
{
?>   
    <tr>
    <td height="43" align="center"><strong><?php echo $res->sec_idno; ?></strong></td>
    <td align="center"><strong><?php echo $res->sec_name; ?></strong></td>
    <td align="center"><strong><?php echo $res->sec_con; ?></strong></td>
    <td align="center">
     <a href="security.php?sec_id=<?php echo $res->sec_id; ?>&Mode=Edit" style="text-decoration:none">
    <img src="../images/edit.png" width="35" height="36" /></a>&nbsp;&nbsp;&nbsp;
    <a href="security.php?sec_id=<?php echo $res->sec_id; ?>&Mode=Delete" style="text-decoration:none" onclick="return confirm('Are You Sure To Delete')">
