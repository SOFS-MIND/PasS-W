...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="3" align="center"><h1>Security Log In</h1></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
...
<br />
      <p style="padding:0px 20px 20px 20px;color:#FFFFFF;text-align:justify">
        <form action="" method="post">    
          <h3 style="color:#FFFFFF">SECURITY ID NO</h3>
...
$sqlup="Select * from security
	where sec_idno ='".$user_uname."' AND sec_pwd='".$user_pwd."'";
...
if($res > 0)
{
$_SESSION['user_id'] = $res->sec_id;
$_SESSION['user_name'] = $res->sec_name;

	echo "<script type='text/javascript'> alert('Login Successfully');</script>";

	echo "<meta http-equiv='refresh' content='0;url=security/index.php'>";
